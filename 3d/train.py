...
if __name__ == '__main__':
    ...
    parser.add_argument('--vis_path', type=str, default='./vis_debug', help="Path where to save the visualization images")
    ...
    #     '--exp_name', 'prova_strade_mie_con_seg_loss',
    #     '--config', '3d/configs/roads_only_with_seg_loss.yaml',
    #     '--continuous',
    #     '--display_prob', '0.001',
    # ])
    ...
    args = parser.parse_args([
        '--exp_name', 'prova_strade_mie_con_seg_loss',
        '--config', '3d/configs/roads_only_with_seg_loss.yaml',
        '--resume', '/data/scavone/cross-dim_i2g_3d/runs/prova_strade_mie_con_seg_loss_20/models/checkpoint_epoch=15.pt',
        '--restore_state',
        '--continuous',
        '--display_prob', '0.001',
    ])
    ...
    # args = parser.parse_args([
    #     '--exp_name', 'prova_strade_seg_loss',
    #     '--config', '/home/scavone/cross-dim_i2g/3d/configs/roads_only_with_seg_loss.yaml',
