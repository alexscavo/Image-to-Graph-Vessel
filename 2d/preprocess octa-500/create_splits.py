...
def main(args):
    ...
    if args.ratio:
        ...
        assignment = simple_patient_ratio_split(patients, DEFAULT_PATIENT_RATIOS)
...
if __name__ == "__main__":
    ...
    args = parser.parse_args(['--root', "/data/scavone/octa500",
                              '--ratio',
                              '--train_patches_num', '1600',
                              '--val_patches_num', '400',
                              '--test_patches_num', '2200',
                             ])
