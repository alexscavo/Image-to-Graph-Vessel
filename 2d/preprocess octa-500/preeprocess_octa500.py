...
def main(args):
    ...
    img_files_all = sorted(in_img.glob("*.bmp"))
...
if __name__ == "__main__":
    ...
    ap.add_argument("--canvas_size", type=int, default=400)
    ...
    args = ap.parse_args(['--root', '/data/scavone/octa500',
                          '--out_root', '/data/scavone/octa500/patches',
                          '--split', '/data/scavone/octa500/splits.csv',
                          '--canvas_size', '400',
                          '--crop', '128',
                          '--overlap', '0.35',
                          '--num_train', '1600',
