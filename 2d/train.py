...
if __name__ == '__main__':
    ...
    # --- PRE-TRAINING --- 
    args = parser.parse_args(['--exp_name', 'pretraining_mixed_synth_alpha_hns',
                              '--config', '2d\configs\config_2d_synth_alpha_hns.yaml',
                              '--display_prob', '0.001'
                             ])
    
    
    # --- FINE TUNING ---
    # args = parser.parse_args(['--exp_name', 'finetuning_mixed_synth_alpha_hns',
    #                         '--config', '2d\configs\config_2d_synth_alpha_hns.yaml',
